...
mcp_server = FastMCP(
    ...
    instructions=(
        ...
        "a Page-linked asset is needed and list_instagram_accounts when an "
        "Instagram identity is needed. For detailed reporting use "
        ...
        "Use planning tools for audience or targeting questions, including "
        "get_targeting_categories for generic category discovery, and "
